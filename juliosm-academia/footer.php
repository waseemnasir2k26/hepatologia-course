      ...
      <div class="footer-col">
        ...
        <?php if ( jsma_is_portal() ) : ?>
          <?php if ( is_user_logged_in() ) : ?>
            ...
            <a href="<?php echo esc_url( home_url( '/courses/' ) ); ?>">Módulos</a>
          <?php else : ?>
            <a href="<?php echo esc_url( wp_login_url( home_url( '/dashboard/' ) ) ); ?>">Iniciar Sesión</a>
          <?php endif; ?>
          <a href="<?php echo esc_url( home_url( '/#soporte' ) ); ?>">Soporte</a>
          <a href="https://cirrosis360.juliosantiagomarcelo.com/" target="_blank" rel="noopener">Conocer el Programa</a>
        <?php else : ?>
...
<?php
$wa_raw   = get_theme_mod( 'jsma_whatsapp', '51917623134' );
$wa_phone = preg_replace( '/\D+/', '', $wa_raw );
$wa_url   = $wa_phone ? 'https://wa.me/' . $wa_phone . '?text=' . rawurlencode( 'Hola Dr. Julio, tengo una consulta sobre Cirrosis 360.' ) : '';
?>
<?php if ( $wa_url ) : ?>
