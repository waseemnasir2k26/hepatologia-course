...
$years         = esc_html( get_theme_mod( 'juliosm_years', '10+' ) );
$doctor_photo  = esc_url( get_theme_mod( 'juliosm_photo', get_template_directory_uri() . '/assets/img/doctor-photo.jpg' ) );
...
$whatsapp      = esc_url( get_theme_mod( 'juliosm_whatsapp', 'https://wa.me/51917623134' ) );
...
<header class="hero" id="hero">
  ...
  <div class="hero-content" data-animate="fade-up">
    ...
    <h1>
      <span class="text-gradient">Cirrosis 360</span><br>
      Entienda y Controle su Cirrosis
    </h1>
    <p class="hero-subtitle">
      Programa educativo del Dr. Julio Santiago Marcelo, <?php echo $specialty; ?>. Para pacientes con cirrosis y sus familias — lenguaje claro, plan paso a paso, clases en vivo.
    </p>
    <div class="hero-cta-row" data-animate="fade-up" data-delay="200">
      <a href="#programa" class="btn btn-gold btn-lg">
        <span>Conocer el Programa</span>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
      </a>
      <a href="<?php echo $mp_link; ?>" class="btn btn-ghost btn-lg" target="_blank" rel="noopener">
        Inscribirme — S/ 247
      </a>
    </div>
  ...
  <div class="container">
    ...
    <div class="doctor-card" data-animate="fade-up" data-delay="100">
      <div class="doctor-photo">
        <?php if ( $doctor_photo ) : ?>
          <img src="<?php echo $doctor_photo; ?>" alt="Dr. Julio Santiago Marcelo, Gastroenterólogo" width="600" height="800" loading="lazy" style="width:100%;height:auto;border-radius:var(--radius-xl);box-shadow:var(--shadow-xl);">
        <?php else : ?>
...
<section class="course-promo" id="programa">
  <div class="container">
    ...
    <h2 class="section-title light" data-animate="fade-up">
      <span class="text-gold">Cirrosis 360</span> — El Programa
    </h2>
    ...
    <div class="price-card" data-animate="fade-up" data-delay="150">
      ...
      <h3 style="color:var(--white);font-family:'Inter',sans-serif;font-size:1.1rem;font-weight:600;">Cirrosis 360 — Programa Completo</h3>
