...
$precio_lanz   = esc_html( get_theme_mod( 'juliosm_precio_lanz', '247' ) );
$precio_reg    = esc_html( get_theme_mod( 'juliosm_precio_reg', '297' ) );
  ...
  <div class="container">
    ...
    <div class="price-card" data-animate="fade-up" data-delay="150">
      ...
      <p class="price-subtitle">
        <s style="color:rgba(255,255,255,0.3);">Precio regular S/ <?php echo $precio_reg; ?></s> &nbsp;&bull;&nbsp; Pago único
      </p>
